...
- `spec-kit-theme` написан по-русски и отчитывается по-русски. Локалей у него нет — на английский запрос он ответит, но своим языком.
- Обе половины `spec-kit-docs` 6.0.0 приведены к перестроенному движку чтением, а не прогоном: сквозной сборки на новых именах ещё не было.
