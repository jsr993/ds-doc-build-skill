...
| **The Figma agent builds** | both skills flattened into one file each for Figma's built-in agent — same contracts, editor-level mechanics | this repository, `adapters/figma-agent/` |
