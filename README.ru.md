...
1. Скачайте [`dist/ds-doc-build.skill`](dist/ds-doc-build.skill) — обычный zip-архив, всегда текущая версия. Рядом лежит та же сборка с версией в имени (`ds-doc-build-4.0.0.skill`), чтобы на глаз отличать, какая версия у вас на диске.
...
│       └── ru.md
├── dist/
│   ├── ds-doc-build.skill        # текущая сборка, постоянное имя
│   └── ds-doc-build-4.0.0.skill  # она же, версия в имени
├── scripts/
