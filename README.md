...
### Почему он останавливается и переспрашивает

Скилл не пишет в файл, пока вы не подтвердите план, и останавливается там, где его правило расходится с тем, что он видит в файле, — вместо того чтобы выбрать за вас. Это сделано намеренно: документация, собранная не так, чинится дольше, чем собирается заново.
